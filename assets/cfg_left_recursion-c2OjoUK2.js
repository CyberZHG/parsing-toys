import"./navbar-KfbvFhEg.js";import{s as o}from"./choose_examples-vr6Go3Mf.js";import{g as s,s as m,a as n}from"./cfg_editor-Bof7UeYh.js";import{u as l,s as c}from"./cfg_result-BlwN4V3V.js";import{C as p,s as i,a as u,g as f}from"./__vite-browser-external-CVGcIm8v.js";const x={example1:"Example 1: S -> S S + | S S * | a",example2:"Example 2: S -> ( L ) | a  L -> L , S | S",example3:"Example 3: A -> C | c d  B -> C | c d  C -> A | B | c d",example4:"Example 4: bexpr -> bexpr or bterm | bterm  bterm -> bterm and bfactor | bfactor  bfactor -> not bfactor | ( bexpr ) | true | false",example5:"Example 5: A -> B  B -> C  C -> D  D -> A"},b={example1:`S -> S S + 
   | S S * 
   | a`,example2:`S -> ( L ) 
   | a L -> L , S 
   | S`,example3:`A -> C | c d
